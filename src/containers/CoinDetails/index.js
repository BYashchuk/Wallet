...
const CoinDetails = ({
	...
	const downloadWallet = walletToSave => {
		...
		// anchor.download = generateFileName(walletToSave.Address)
					...
					<div className="col-5">
						<div className='row'>
							...
							<div className="col-8">
								...
								<div className='download-wallet-ico' onClick={() => {
									const address = selectedCoin.Address
									const walletToSave = wallets.filter(wallet => wallet.Address === address)[0]
